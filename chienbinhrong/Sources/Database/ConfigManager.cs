...
namespace NgocRongGold.DatabaseManager
{
    public class ConfigManager
    {
        ...
        public string TextExpUp { get; set; } = "";
        ...
        public bool SuKienVuLan { get; set; }
        public bool SuKienNoel { get; set; }
        public double Rate_Thỏi_Vàng { get; set; }
        ...
        public double Rate_Hồng_Ngọc { get; set; }

        public int MuaGiai { get; set; }
        ...
        public void Init()
        {
            try
            {
                ...
                SuKienVuLan = Boolean.Parse(_configuration.GetSection("server").GetSection("event-vulan").Value);
            }
            catch (Exception e)
            {
                Os = 1;
                Link = "KhanhDTK:192.168.0.105:14445:0,0,0";
            ...
            try
            {
                ...
                Rate_Thỏi_Vàng = double.Parse(_configuration.GetSection("rate-thoivang").Value);
                ...
                Rate_Hồng_Ngọc = double.Parse(_configuration.GetSection("rate-hongngoc").Value);
                MuaGiai = int.Parse(_configuration.GetSection("muagiai").Value);
            }
            catch (Exception e)
            {
                MaxConnectSocket = 10;
