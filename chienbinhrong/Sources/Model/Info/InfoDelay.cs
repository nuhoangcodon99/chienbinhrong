...
namespace NgocRongGold.Model.Info
{
    public class InfoDelay
    {
        ...
        public long DelayHopThe { get; set; }
        public InfoDelay()
        {
            DelayHopThe = 10000 + ServerUtils.CurrentTimeMillis();
            ...
            ChatTheGioi = -1;
            DelayODo = 10000 + ServerUtils.CurrentTimeMillis();
            TeleportToPlayer = -1;
            Trade = -1;
