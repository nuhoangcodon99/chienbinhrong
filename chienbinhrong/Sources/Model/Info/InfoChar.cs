...
using System;
using NgocRongGold.Application.Extension.Task_Everyday;
using NgocRongGold.Application.Extension.KeoBuaBao;
using Chiến_Binh_Rồng.Sources.Model.Info;
...
namespace NgocRongGold.Model.Info
{
    public class InfoChar
    {
        ...
        public long ThoiGianDuaHau { get; set; } //Thời gian dưa hấu, != 0 là có dưa
        public long ThoiGianNoiBanh { get; set; } //Thời gian nấu bánh, != 0 là có bánh
       ...
       public bool isDiemDanh { get; set; }
        ...
        public List<Role2> Roles2 { get; set; }
        public Role1 Roles1 { get; set; }
        public LuckyNumber LuckyNumber { get; set; }
        public KeoBuaBao_Player KeoBuaBao { get; set; }
        public InfoNewSkill NewSkill { get; set; }
        public InfoChar()
        {
            DiscipleId = -1;
            MasterId = -1;
            KeoBuaBao = new KeoBuaBao_Player();
            LuckyNumber = new LuckyNumber();
            Roles1 = new Role1();
            Roles2 = new List<Role2>();
            VIP = 0;
            IsOutZone = false;
            PointQuayThuong = 0;
            PointSanBoss = 0;
