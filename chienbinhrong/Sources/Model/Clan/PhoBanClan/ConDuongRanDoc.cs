        ...
        public void SendTextTime(Clan clan = null, Character.Character character = null)
        {
            if (clan != null)
            {
                foreach (var clanMember in clan.Thành_viên)
                {
                    ...
                    member.CharacterHandler.SendMessage(Service.ItemTimeWithMessage(Name, (int)TextTime.CON_DUONG_RAN_DOC, (int)((Time - ServerUtils.CurrentTimeMillis()) / 1000)));
                }
            }
            if (character != null) character.CharacterHandler.SendMessage(Service.ItemTimeWithMessage(Name, (int)TextTime.CON_DUONG_RAN_DOC, (int)((Time - ServerUtils.CurrentTimeMillis()) / 1000)));
        }
