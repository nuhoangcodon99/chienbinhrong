...
namespace NgocRongGold.Application.Extension
{
    public class MenuAdminRecode
    {
        ...
        {
            var getCharSelect = (Model.Character.Character)ClientManager.Gi().GetCharacter(NameCharSelect);
        ...
        public void HandlerBanAccount(string reason)
        {
            ...
            ClientManager.Gi().SendMessageCharacter(Service.ServerMessageVip("Nhân vật " + NameCharSelect + " đã bị khóa tài khoản với lý do: " + reason));
