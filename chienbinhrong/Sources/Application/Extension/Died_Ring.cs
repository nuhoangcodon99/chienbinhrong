    ...
    /*public class Died_Ring
    {
        public class Runtime
        {
            ...
            public void Register(Character character)
            {
                ...
                {
                    character.Zone.ZoneHandler.SendMessage(Service.NpcChat(21, "Con đã đăng ký ời"));
        ...
        {
            character.InfoChar.X = 180;
            character.InfoChar.Y = 408;
            MapManager.JoinMap(character, 112, ServerUtils.RandomNumber(20), false, false, 0);
        }
        public void Boss(Character character)
        {
            var boss = new Boss();
            boss.CreateBossNoAttack(Runtime.gI().ListTypeBoss[character.DataVoDaiSinhTu.Round], 521, 336, true, character.HpFull + boss.HpFull + (20*character.DataVoDaiSinhTu.Round));
