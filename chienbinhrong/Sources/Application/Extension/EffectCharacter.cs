...
namespace NgocRongGold.Application.Extension
{
    ...
    {
        public static Message addEff(short id, short x, short y, int layer, int loop, short loopCount)
        {
        ...
        public static Message sendInfoEffChar(int charId,int id, int layer, int loop, int loopCount, int isStand)
        {
        ...
        public static Message removeEffChar(int charId,short id)
        {
