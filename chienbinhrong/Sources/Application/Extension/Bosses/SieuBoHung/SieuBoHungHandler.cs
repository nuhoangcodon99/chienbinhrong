...
namespace NgocRongGold.Application.Extension.Bosses.SieuBoHung
{
    public class SieuBoHungHandler : ICharacterHandler
    {
        ...
        public SieuBoHungHandler(Boss boss)
        {
            Boss = boss;
        }
        ...
        private void IdleChatMessage(long timeServer)
        {
            ...
            SendBossChat(TextServer.gI().SOIHECQUYN_CHAT_IDLE[ServerUtils.RandomNumber(TextServer.gI().SOIHECQUYN_CHAT_IDLE.Count)]);
