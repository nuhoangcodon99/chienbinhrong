...
namespace NgocRongGold.Application.Extension.Bosses.Tau77
{
    public class Tau77Handler : ICharacterHandler
    {
        ...
        {
            Boss.InfoDelayBoss.DelayRemove = DataCache._1SECOND * 30 + ServerUtils.CurrentTimeMillis();
            var timeServer = ServerUtils.CurrentTimeMillis();
            var checkSize = 1000;
