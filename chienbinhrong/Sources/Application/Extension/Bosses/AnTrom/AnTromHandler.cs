...
namespace NgocRongGold.Application.Extension.Bosses.AnTrom
{
    public class AnTromHandler : ICharacterHandler
    {
        ...
        public AnTromHandler(Boss boss)
        {
            Boss = boss;
        }
        ...
        public long totalGoldSteal = 0;
        private void IdleChatMessage(long timeServer)
        {

            SendBossChat($"Haha, trộm được {ServerUtils.GetMoneys(totalGoldSteal)} vàng rồi");
        ...
        {
            var crit = Boss.InfoChar.OriginalCrit;
