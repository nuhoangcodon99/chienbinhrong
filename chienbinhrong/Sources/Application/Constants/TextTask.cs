...
namespace NgocRongGold.Application.Constants
{
    ...
    {
        public static string newGame = "Chào mừng {0} đến với Ngọc Rồng Online!\nMình là {1} sẽ đồng hành cùng bạn ở thế giới này.";
        public static string MessageLoginGame = "Chào mừng {0} đến với Ngọc Rồng Online !\nHãy ủng hộ bằng cách mở thành viên để duy trì server nhé.\n|8|Lưu ý không sử dụng Auto Đập Đồ để tránh tình trạng tự mất thỏi vàng !";
