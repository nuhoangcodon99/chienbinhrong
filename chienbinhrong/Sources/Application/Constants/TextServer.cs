...
namespace NgocRongGold.Application.Constants
{
    public class TextServer
    {
        ...
        public readonly string MAINTENANCE = "Hệ thống sẽ bảo trì sau {0} giây nữa, vui lòng thoát game";
        ...
        public readonly string ONLY_DISCIPLE = "Chỉ dành cho đệ tử";
        ...
        public readonly string NOT_ENOUGH_STAMINA_DISCIPLE = "Sư phụ ơi cho con đậu thần";
        ...
        public readonly string NEED_10_DIAMOND_LOCK = "Cần 10 hồng ngọc";
        ...
        public readonly List<string> XINBATO_CHAT_IDLE = new List<string>() { "Cho tôi xin 99 bình nước, làm ơn", "Đường ống nước quê tôi vỡ" };
        public readonly List<string> SOIHECQUYN_CHAT_IDLE = new List<string>() { "Gâu gâu, ẳng ẳng", "Nhìn gìii, cắn chết mẹ giờ ><" };
        public readonly List<string> TDST_CHAT_COMBAT = new List<string>() { "Chỉ là bọn con nít","Đại Ca Fide có nhầm không nhỉ?","Một mình tao chấp hết tụi bây", "Chán", "Ê cố lên nhóc", "Oải rồi hả?", "HAHAHA" };
        ...
        public readonly List<string> TRONG_TAI = new List<string>() {"Đại hội võ thuật\nthế giới là một giải đấu uy\ntín bậc nhất", "Đại hội võ thuật\nthế giới là nơi quy tụ mọi chiến binh mạnh nhất" };
        public readonly List<string> TRONG_TAI2 = new List<string>() { "" };
