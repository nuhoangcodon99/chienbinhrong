...
namespace NgocRongGold.Application.Main
{
    public class Service
    {
        ...
        public static Message ShowWinNumber1(string num)
        {
            var message = new Message(-126);
            message.Writer.WriteByte(1);
            message.Writer.WriteByte(0);//nothing
            message.Writer.WriteUTF(num);
            message.Writer.WriteUTF(num);
            return message;
        }
        public static Message ShowWinNumber0(List<string> consoPick)
        {
            var message = new Message(-126);
            message.Writer.WriteByte(1);
            var pick = "";
            for (int i = 0; i < consoPick.Count; i++)
            {
                if (i == 0)
                {
                    pick += $"{consoPick[i]}";
                }
                else if (i == consoPick.Count - 1)
                {
                    pick += $"{consoPick[i]}";
                }
                else
        ...
        public static Message SendNewBackground()
        {
            try
            {
                var bytes = Cache.Gi().DATA_VERSION_BgItem_X2;
        ...
        public static Message SendCombinne6(short iconId1, short iconId2, short npcId = 21)// hiệu ứng cskb
        {
            try
            {
                var message = new Message(-81);
        ...
        public static Message SendNewImage(int zoomLevel)
        {
            ...
            try
            {
                ...
                var version = Cache.Gi().VersionIconX1;
                switch (zoomLevel)
                {
                    case 2:
                        version = Cache.Gi().VersionIconX2;
                        break;
                    case 3:
                        version = Cache.Gi().VersionIconX3;
                        break;
                    case 4:
                        version = Cache.Gi().VersionIconX4;
                        break;
                }

                message.Writer.WriteShort(version.Length);
                message.Writer.Write(version);
                return message;
            }
            catch (Exception e)
            {
        ...
        public static async Task<bool> SendImageResource2Async(ISession_ME session)
        {
            ...
            //foreach (var fileInfo in dir)
            while (count != dir.Length)
            {
                var fileInfo = dir[count];
                var fileName = $"/{pathName}/{fileInfo.Name.Replace($"x{session.ZoomLevel}", "")}";
        ...
        public static Message SendIcon(int zoomLevel, int id)
        {
            ...
            var cache = Cache.Gi().DATA_ICON_X1;
            switch (zoomLevel)
            {
                case 2:
                    cache = Cache.Gi().DATA_ICON_X2;
                    break;
                case 3:
                    cache = Cache.Gi().DATA_ICON_X3;
                    break;
                case 4:
                    cache = Cache.Gi().DATA_ICON_X4;
                    break;
            }
            byte[] bytes = cache[id];
            if (bytes is null)
            {
                ...
                message.Writer.WriteInt(0);
                Server.Gi().Logger.Print("zoomlevel: " + zoomLevel + " | id: " + id + " icon not found", "manager");
                return message;
            }
            message.Writer.WriteInt(id);
            message.Writer.WriteInt(bytes.Length);
        ...
        public static Message SendEffect(int version, int zoomLevel, short id, short idTemp, int setDragon)
        {
            ...
            try
            {
                ...
                var bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(string.Format(DatabaseManager.ConfigManager.gI().EffectData, zoomLevel, idT, type)));
                var bytes2 = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(string.Format(DatabaseManager.ConfigManager.gI().EffectImg, zoomLevel, idT, type)));
                var message = new Message(-66);
                message.Writer.WriteShort(idT);
                if (bytes == null)
                {
                    message.Writer.WriteInt(0);
                    Server.Gi().Logger.Print("zoomlevel: " + zoomLevel + " | id: " + id + " effect data not found", "manager");
                }
                else
                {
                    message.Writer.WriteInt(bytes.Length);
                ...
                {
                    message.Writer.WriteInt(0);
                    Server.Gi().Logger.Print("zoomlevel: " + zoomLevel + " | id: " + id + " effect image not found", "manager");
                }
                else
                {
        ...
        //63 Menu Player
        public static Message MenuPlayer(ICharacter character, int playerId)
        {
            try
            {
                var player = character.Zone.ZoneHandler.GetCharacter(playerId);
                if (player == null) return null;
                var message = MessageSubCommand(63);
                var MenuPlayers = new List<MenuPlayerTemplate>();
                var charReal = (Model.Character.Character)character;
                if (PlayerMenu.ConditionToPleaseDisciple(charReal, player, false))
                {
                    MenuPlayers.Add(DataCache.MenuPlayers[2]);
                }
                if (PlayerMenu.ConditionToBanAccount(charReal))
                {
                    MenuPlayers.Add(DataCache.MenuPlayers[4]);
                }
                if (PlayerMenu.ConditionToBuyAvatar(charReal, player))
                {
                    var menuBuyAvatar = DataCache.MenuPlayers[0];
                    var itemAvatar = player.ItemBody[5];
                    if (itemAvatar == null) return null;
                    var saleCoinAvatar = PlayerMenu.SaleCoinBuyAvatar(itemAvatar);
                    string.Format(menuBuyAvatar.Caption2, saleCoinAvatar);
                    MenuPlayers.Add(DataCache.MenuPlayers[0]);
                }
                if (charReal.CharacterHandler.GetItemBagById(569) != null)
                {
                    MenuPlayers.Add(DataCache.MenuPlayers[6]);
                }
                message.Writer.WriteByte(MenuPlayers.Count);
                MenuPlayers.ForEach(menu =>
                {
                    message.Writer.WriteUTF(menu.Caption);
                    message.Writer.WriteUTF(menu.Caption2);
                    message.Writer.WriteShort(menu.MenuSelect);
                });
                return message;
            }
            catch (Exception e)
        ...
        public static Message ClanMessage(ClanMessage msg)
        {
            try
            {
                ...
                message.Writer.WriteUTF(msg.PlayerName);
                message.Writer.WriteByte(msg.Role);
                message.Writer.WriteInt((int)(msg.Time - 1000000000));
                switch (msg.Type)
                {
                    case 0:
                        message.Writer.WriteUTF(msg.Text);
        ...
        //-50 _ ME
        public static Message ClanMember(List<ClanMember> members, int ver = 237)
        {
            try
            {
        ...
        public static Message SkillNotFocus20(int charId, int id, byte typeFrame, short timeGong, byte isFly, byte typePaint, byte typeItem, byte dir = 1) // khi gồng xong
        {
            try
            {
                var message = new Message(-45);
                ...
                message.Writer.WriteByte(typePaint); // type paint || 0 la từ client 2.3.1 còn lại là 1 sendImgByName của client thấp
                message.Writer.WriteByte(typeItem); // type item
                return message;
            }
            catch (Exception e)
            {
        ...
        public static Message SkillNotFocus21(int charId, int skillId, short x, short y, short timeAttack, short RangeAttack, byte typePaint, byte typeItem, List<ICharacter> characters, int monsters) // chưởng
        {
            try
            {
                var message = new Message(-45);
                ...
                message.Writer.WriteByte(typePaint); // type paint
        ...
        public static Message SkillNotFocus21(int charId, int skillId, short x, short y, short timeAttack, short RangeAttack, byte typePaint, byte typeItem, Character character) // chưởng
        {
            try
            {
                var message = new Message(-45);
                ...
                if (skillId == 26)
                {
                    ...
                    for (int i2 = 0; i2 < character.Zone.Characters.Count; i2++)
                    {
                        ...
                        if (check && SkillHandler.CondittionToAttack(character, @char))
                        {
                            message.Writer.WriteByte(1);
                ...
                message.Writer.WriteByte(typePaint); // type item
                return message;
            }
            catch (Exception e)
            {
                    ...
                    case 0:
                        {
                            switch (idShop)
                            {
                                ...
                                case 3333:
                                    var itemsells = character.ItemSells;
                                    message.Writer.WriteUTF("Mua lại");
                                    message.Writer.WriteByte(itemsells.Count);
                                    itemsells.ForEach(itemShop =>
                                    {
                                        var options = itemShop.Options.Copy();
                                        var itemTemplate = ItemCache.ItemTemplate(itemShop.Id);
                                        message.Writer.WriteShort(itemShop.Id);
                                        message.Writer.WriteInt(itemShop.Vang);
                                        message.Writer.WriteInt(itemShop.Ngoc);
                                        message.Writer.WriteByte(options.Count);
                                ...
                                default:
                                    shopTemplates.ForEach(shop =>
                                    {
                                        ...
                                        shop.ItemShops.ForEach(itemShop =>
                                        {
                                            var iditem = itemShop.Id;
                                            var buygold = itemShop.Ngoc;
                                            var itemTemplate = ItemCache.ItemTemplate(iditem);
                                            // var options = itemShop.Options.Copy();
                                            var options = itemShop.Options;
                                            ...
                                            message.Writer.WriteInt(itemShop.Vang * percent);
                                            message.Writer.WriteInt(buygold * percent);

                                            if (idShop < 4 && character.InfoChar.ItemAmulet.ContainsKey(itemShop.Id))
                                            {
                                                var time = character.InfoChar.ItemAmulet.FirstOrDefault(i => i.Key == itemShop.Id).Value;
                                            ...
                                            message.Writer.WriteByte(itemShop.IsNewItem ? 1 : 0);
                                            if (itemTemplate.IsTypeBody())
                                            {
                                                message.Writer.WriteByte(1); // send part
                                                if (itemTemplate.Type == 5)
                                                {
                                                    if (ItemCache.IsAvatar(itemShop.HeadTemp))
                                                    {
                                                        message.Writer.WriteShort(itemShop.HeadTemp);
                                                        message.Writer.WriteShort(itemShop.BodyTemp);
                                                        message.Writer.WriteShort(itemShop.LegTemp);
                                                        message.Writer.WriteShort(itemShop.BagTemp);
                                                    }
                                                    else
                                                    {
                                                        message.Writer.WriteShort(itemShop.HeadTemp);
                                                        message.Writer.WriteShort(itemShop.BodyTemp == -1 ? ItemCache.PartHeadToBody(itemShop.HeadTemp) : itemShop.BodyTemp);
                                                        message.Writer.WriteShort(itemShop.LegTemp == -1 ? ItemCache.PartHeadToLeg(itemShop.HeadTemp) : itemShop.LegTemp);
                                                        message.Writer.WriteShort(itemShop.BagTemp);
                                                    }
                                                }
                                                else
                                ...
                                case 4444:
                                    {
                                        ...
                                        shopTemplates.ForEach(shop =>
                                        {
                                            if (shop.Name.Contains("Sở hữu"))
                                            {
                                                var roles = character.InfoChar.Roles1;
                                                message.Writer.WriteUTF(string.Format(shop.Name, roles.Roles.Count).Replace("$", "\n"));
                                                message.Writer.WriteByte(roles.Roles.Count);
                                                roles.Roles.ForEach(role =>
                                                {
                                                    var itemTemplate = ItemCache.ItemTemplate((short)role.Id);
                                                    message.Writer.WriteShort(role.Id);
                                                    message.Writer.WriteShort(12400);
                                                    message.Writer.WriteInt(300);
                                                    message.Writer.WriteByte(role.Options.Count);
                                            ...
                                            else
                                            {
                                                ...
                                                shop.ItemShops.ForEach(itemShop =>
                                                {
                                                    var itemTemplate = ItemCache.ItemTemplate(itemShop.Id);
                                                    message.Writer.WriteShort(itemShop.Id);
                                                    message.Writer.WriteShort(itemShop.Ngoc);
                                                    message.Writer.WriteInt(itemShop.Vang);
                                                    message.Writer.WriteByte(itemShop.Options.Count);
                                                    itemShop.Options.ForEach(option =>
                                                    {
                                                        message.Writer.WriteByte(option.Id);
                                                        message.Writer.WriteShort(option.Param);
                                                    });
        ...
        public static void RewardItemTop(Character character)
        {

        }
        public static Message GiftBox(List<Item> items)
        {
            Message message;
            try
            {
                ...
                message.Writer.WriteByte(4);
                message.Writer.WriteByte(1);
                message.Writer.WriteUTF("Quà tặng");
                if (items.Count < 100)
                {
                    message.Writer.WriteByte(items.Count);
                }
        ...
        //    try
        //    {
        //        var bg = Cache.Gi().DATA_BgItem_X1[id];
        //        switch (zoomLevel)
        //        {
        //            case 2:
        //                bg = Cache.Gi().DATA_BgItem_X2[id];
        //                break;
        //            case 3:
        //                bg = Cache.Gi().DATA_BgItem_X3[id];
        //                break;
        //            case 4:
        //                bg = Cache.Gi().DATA_BgItem_X4[id];
        //                break;
        //        }
        //        var message = new Message(-32);
        //        message.Writer.WriteShort(id);
        //        message.Writer.WriteInt(bg.Length);
        //        message.Writer.Write(bg);
        //        return message;
        //    }
        //    catch (Exception e)
        //    {
        ...
        public static Message UpdateSkill1(short id, byte typePaint)
        {
            try
            {
                var message = MessageSubCommand(62);
        ...
        public static Message PlayerLoadAll(ICharacter character, string text = "")
        {
            ...
            try
            {
                ...
                // }
                message.Writer.WriteShort(character.InfoChar.EffectAuraId);///character.InfoChar.EffectAuraId
        ...
        //-28_10
        public static Message RequestMapTemplate(TileMap tileMap, IZone zone, ICharacter character)
        {
        ...
        public static Message UpdateItem(int type)
        {
            try
            {
                ...
                switch (type)
                {
                    ...
                    case 100:
                        {
                            var dataArrHead = Cache.Gi().DataArrHead;
                            message.Writer.WriteShort(dataArrHead.Count);
                            foreach (var array in dataArrHead)
                            {
                                message.Writer.WriteByte((byte)array.Length);
                                foreach (var item in array)
                                {
                                    message.Writer.WriteShort(item);
                                }
                            }
                            break;
                        }
        ...
        //-24
        public static Message MapInfo(IZone zone, ICharacter character)
        {
            ...
            try
            {
                ...
                foreach (var waypoint in tileMap.WayPoints)
                {
                ...
                if (character.InfoChar.MapId - 21 == character.InfoChar.Gender)
                {
                    ...
                    if (charRel.InfoChar.ThoiGianDuaHau > 0) //Có dưa hấu
                    {
                        addCountNpc += 1;
                        hasDuaHau = true;
                    }
                ...
                {
                    var charRel = (Character)character;
                    if (SuKienHungVuong.MapInitNpc.Contains(charRel.InfoChar.MapId))
                    {
                        if (SuKienHungVuong.GetZoneInitNpc(charRel.InfoChar.MapId) == charRel.Zone.Id)
                        {
                            addCountNpc += 1;
                            hasVuaHung = true;
                        }
                ...
                foreach (var item in zone.ItemMaps.Values.ToList())
                {
                    message.Writer.WriteShort(item.Id);
                ...
                foreach (var bgItem in tileMap.BackgroundItems)
                {
                ...
                foreach (var action in tileMap.Actions)
                {
        ...
        //-17 _ Me
        public static Message MeDie(ICharacter character, long minePower)
        {
            try
            {
        ...
        public static Message PlayerAdd(ICharacter character, string text = "")
        {
            ...
            try
            {
                ...
                {
                    var clan = ClanManager.Get(character.ClanId);
                    if (clan != null && clan.shortName is not "")
                    {
                        name = $"{text}[{clan.shortName}]{character.Name}";
                    }
                }
        ...
        public static Message SendMonsterTemplate(int zoomLevel, int id)
        {
            try
            {
                ...
                var imageMob = Cache.Gi().IMAGE_MONSTERS_X1;
                var dataMob = Cache.Gi().DATA_MONSTERS_X1;
                switch (zoomLevel)
                {
                    case 2:
                        dataMob = Cache.Gi().DATA_MONSTERS_X2;
                        imageMob = Cache.Gi().IMAGE_MONSTERS_X2;
                        break;
                    case 3:
                        dataMob = Cache.Gi().DATA_MONSTERS_X3;
                        imageMob = Cache.Gi().IMAGE_MONSTERS_X3;
                        break;
                    case 4:
                        dataMob = Cache.Gi().DATA_MONSTERS_X4;
                        imageMob = Cache.Gi().IMAGE_MONSTERS_X4;
                        break;
                }
                //byte[] data = File.ReadAllBytes(ServerUtils.ProjectDir("RES/monster/x" + zoomLevel + "/Data/DataMonster_" + id + "_0"));
                //byte[] img = File.ReadAllBytes(ServerUtils.ProjectDir("RES/monster/x" + zoomLevel + "/Image/ImageMonster_" + id + "_0.png"));
                byte[] data = dataMob[id];
                byte[] img = imageMob[id];
                if (data == null && img == null)
                {
                    Server.Gi().Logger.Print("zoom: " + zoomLevel + " | id: " + id + " all mob template not found", "manager");
                    return null;
                }else if (img == null)
                {
                    Server.Gi().Logger.Print("zoom: " + zoomLevel + " | id: " + id + " image mob template not found", "manager");
                    return null;
                }
                else if (data == null)
                {
                    Server.Gi().Logger.Print("zoom: " + zoomLevel + " | id: " + id + " data mob template not found", "manager");
                    return null;
                }
                ...
                message.Writer.WriteInt(img.Length);
                message.Writer.Write(img);
                switch (id)
                {
                    case 77:
                    case (>= 80 and <= 85):
                    case 92 or 93:
                        message.Writer.WriteByte(1);
                        var frameBossSpecial = File.ReadAllBytes(ServerUtils.ProjectDir("RES/monster/frameHT_NewBOSS_" + id));
                        if (frameBossSpecial is null)
                        {
                            message.Writer.WriteByte(0);
                            Server.Gi().Logger.Print("zoom: " + zoomLevel + " | id: " + id + " frameNewBoss not found", "manager");
                            break;
                        }
                        message.Writer.Write(frameBossSpecial);
                        break;
                    default:
                        message.Writer.WriteByte(0);
                        break;
                }
                Server.Gi().Logger.Debug($"SendMobTemplate in Service.cs: Mob " + id);
                return message;
            }
            catch (Exception e)
            {
                Server.Gi().Logger.Error($"Error SendMobTemplate in Service.cs: {e.Message} \n {e.StackTrace}", e);
        ...
        public static Message WriteLogin(List<Character> characters)
        {
            try
            {
                ...
                for (int i = 0; i < characters.Count; i++)
                {
                    ...
                    {
                        var gender = ServerUtils.RandomNumber(0, 3);
                        message.Writer.WriteInt(0);
                        message.Writer.WriteUTF("Tạo nhân vật mới");
                        message.Writer.WriteShort(DataCache.hairID[gender][ServerUtils.RandomNumber(DataCache.hairID[gender].Count)]);
                        message.Writer.WriteShort(DataCache.ListChooseGender[gender][1]);
                        message.Writer.WriteShort(DataCache.ListChooseGender[gender][2]);
                        message.Writer.WriteLong(1200);
                    }
                    else
                    {
                        message.Writer.WriteInt(character.Id);
            ...
            {
                Server.Gi().Logger.Error($"Error WriteLogin in Service.cs: {e.Message} \n {e.StackTrace}", e);
                return null;
            }
        }
        ...
        //29 _ ME
        public static Message OpenUiZone(IMap map)
        {
            try
            {
                var message = new Message(29);
        ...
        public static Message SendTask(Character character)
        {
            try
            {
        ...
        public static Message SendImgByName(int zoomLevel, string name)
        {
            ...
            {
                var message = new Message(66);
                var temp = Cache.Gi().ImgByName[name][zoomLevel - 1];
                if (temp is null)
                {
                    message.Writer.WriteUTF(name);
                    message.Writer.WriteByte(0);
                    ...
                    Server.Gi().Logger.Print("Zoomlevel: " + zoomLevel + " name: " + name + " imgbyname not found", "manager");
                    return message;
                }
                var bytes = temp.Data;
                message.Writer.WriteUTF(name);
                message.Writer.WriteByte(temp.Frame);
                message.Writer.WriteInt(bytes.Length);
                message.Writer.Write(bytes);
                return message;
            }
        ...
        public static Message SendImgWater(short icon)
        {
            var msg = new Message(24);
            msg.Writer.WriteByte(3);
            msg.Writer.WriteShort(icon);
            return msg;
        }
        public static Message SendRole(int characterId, int timeBySecond, int effId)
        {
            var msg = new Message(24);
            msg.Writer.WriteByte(2);
            msg.Writer.WriteInt(characterId);
            msg.Writer.WriteByte(timeBySecond);
            msg.Writer.WriteShort(effId);
            return msg;
        }
        public static Message ServerMessageVip(string message)
        {
            var msg = new Message(24);
        ...
        public static Message PlayGuest(string username)// menu dang ky tai khoan
        {
