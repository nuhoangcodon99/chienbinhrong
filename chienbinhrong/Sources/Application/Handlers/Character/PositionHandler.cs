...
namespace NgocRongGold.Application.Handlers.Character
{
    public class PositionHandler
    {
        ...
        public static void SetUpPosition(ICharacter character, int oldMap, int newMap)
        {
            ...
            {
                case 21:
                    SetupPositionXy(character, 482, 336);
                    break;
                case 22:
                    SetupPositionXy(character, 209, 336);

                    break;
                case 23:
                    SetupPositionXy(character, 452, 336);
                    break;
                case 47:
                    if (oldMap is 1)
                    {
                        SetupPositionXy(character, 45, 336);
                        break;
                    }
                    SetupPositionXy(character, 448, 336);
                    break;
            }
            switch (oldMap)
            {
                ...
                case 5:
                {
                    switch (newMap)
                    {
                        ...
                        case 29:
                        {
                            ...
                            case 165:
                                SetupPositionXy(character, 205, 384);
                                break;
                    }
